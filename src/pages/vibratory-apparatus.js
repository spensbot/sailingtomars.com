  ...
  return (
    <Layout seoTitle="Vibratory Apparatus" usesHeader usesFooter>
      ...
      <p>
        ...
        Systems. We integrated many "vibe pans" in our facilities as a means of
        providing and even material spread to a sorting machine. These machines
        are typically expensive, large, and transit an incredible amount of
        vibrational energy into the structure that supports them.
      </p>
      ...
      <p>
        ...
        3d-printed a small-scale prototype. It was far too flimsy. I iterated on
        the idea 3 more times, and to my surprise, the 4th prototype worked
        perfectly.
      </p>
      ...
      <p>
        ...
        run the motor and read the system's frequency with an accelerometer. It
        worked perfectly. Then I created a provisional patent so I could shop
        the idea around to companies without the expense of creating a full
        utility patent
      </p>
      ...
      <p>
        ...
        with. After a few weeks of work, we realized that benefits of the design
        would be offset by manufacturing costs necessary to allow the leaf
        spring to withstand the high-stress cyclic loading required by the
        design.
      </p>
      <p>
      ...
      <iframe src="https://docs.google.com/document/d/e/2PACX-1vTec_41p7UI0xhOp1sU4nGnMYj31GFegy3j5GTXKW1roSPBucz1oTBx2kRXYj1-xqxoZJ4-BQPw7C5S/pub?embedded=true"></iframe>
      ...
      <iframe src="https://docs.google.com/document/d/e/2PACX-1vRhH84-_G4nXIlEeunBDfDNYUskLabUGiF8cRjNdGsnw1kmMgiJt2RAu1GKJd9D8s1hF0QFx6QUVF_7/pub?embedded=true"></iframe>
      <h2>Design Analysis Spreadsheet</h2>
      <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTlKIkary6VqYtpBsnjDLq2Qo8k97Th4OoDoL9go3wAEdUkEHS-1o5KWWW0IH7R7Z10iaAcy73J1umA/pubhtml?widget=true&amp;headers=false"></iframe>
