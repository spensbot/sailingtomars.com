...
export default function AboutTheName() {
  return (
    <SiteContainer>
    <Spacer />
    <Box display="flex" flexDirection="row" alignItems="top" flexWrap="wrap" mx="-20px">
      <Box flex="2" minWidth="15rem" pb={3} mx="20px">
        ...
        <Typography component="p" gutterBottom>
          After graduating as a Mechanical Engineer in 2015, I realized that I wasn't sure how I wanted to spend my life. I began to explore anything of interest: programming, art, technology, language, etc. I traveled the world, and pushed myself at every chance.
        </Typography>
        <Typography component="p" gutterBottom>
          I stumbled upon a personal cirriculum I like to call project-based learning. First, pick something you want to create. Then, learn whatever you need to make it happen. As a result, I've created a few cool things.
        </Typography>
