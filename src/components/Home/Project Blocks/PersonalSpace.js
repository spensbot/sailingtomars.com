...
export default function PersonalSpace() {
  ...
  return (
    <ProjectBlock name="Personal Space" Image={projectImage} url={links.personalSpace.home} hours="3.5" coreTechnology="C# / Unity" githubUrl={links.personalSpace.github}>
